...
public class TestResponseBuilderForOneBox extends TestCase {
    ...
    private static final String XML_SYSTEM_ID = GSAClient.DEFAULT_XML_SYSTEM_ID;
    
    public void testOneBox10() throws Exception {
        GSAResponse response = ResponseBuilder.buildResponse(
                new FileInputStream("src/test/data/OneBox10.xml"), XML_SYSTEM_ID);
    ...
    public void testOneBox100() throws Exception {
        GSAResponse response = ResponseBuilder.buildResponse(
                new FileInputStream("src/test/data/OneBox100.xml"), XML_SYSTEM_ID);
